...
solve ((elf1, elf2):tasks)
    | (start elf1 >= start elf2 && start elf1 <= end elf2) || (end elf1 >= start elf2 && end elf1 <= end elf2) = 1 + solve tasks
    | (start elf2 >= start elf1 && start elf2 <= end elf1) || (end elf2 >= start elf1 && end elf2 <= end elf1) = 1 + solve tasks
